...
cholib::trackingWheel horizontalSensor;
cholib::trackingWheel perpendicularSensor;
vex::distance wall 

cholib::Coordinates coordinates;
cholib::Coordinates previousCoordinates;
...
void cholib::setCoordinates(cholib::Coordinates coordinates, bool radians = true) {
